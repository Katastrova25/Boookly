...
class books extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return   MultiBlocProvider(providers: [
      BlocProvider(create: (context) => AllBookCubit(HomeScreenRepo(ApiService(dio: Dio())))..getAllBooks() ),
      BlocProvider(create: (context) => BestSellercubit(HomeScreenRepo(ApiService(dio: Dio())))..getBestSellers() ),
    ], child:  MaterialApp(
